            ...
            <div className="nav-links">
              ...
              <div className="nav-group">
                ...
                <div className="nav-dropdown">
                  ...
                  <Link href="/Afstuderen/feedback-stakeholders">Stakeholders</Link>
                  <Link href="/Afstuderen/leerdoel-1-presenteren">Leerdoel: Presenteren</Link>
                  <Link href="/Afstuderen/vakdoel-ai-zoekgedrag">Vakdoel: AI-Zoekgedrag</Link>
                  <Link href="/Afstuderen/vakdoel-gedragseconomie">Vakdoel: Gedragseconomie</Link>
